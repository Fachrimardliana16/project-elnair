...
<section id="testimoni" class="testi-luxury pattern-bg">
    <div class="container">
        <div class="section-header reveal">
            <span style="letter-spacing: 8px;">Echoes of Faith</span>
            <h2 style="font-size: clamp(2rem, 6vw, 3.5rem);">Kisah Perjalanan Jamaah</h2>
        </div>
        <div class="testi-grid-responsive">
            @foreach($testimonials->take(3) as $testi)
            <div class="testi-card-luxury reveal">
                <div class="testi-glass-bg" style="background: rgba(255,255,255,0.7);"></div>
                <div class="testi-content-wrap" style="position: relative; z-index: 2;">
                    ...
                    <div class="testi-body-luxury">
                        @if($testi->video_url)
                            ...
                            <p style="font-size: 0.9rem; color: var(--brand-dark); line-height: 1.5; margin-top: 1rem;">{{ $testi->quote }}</p>
                        @else
                            <i class="fas fa-quote-left" style="font-size: 1.5rem; opacity: 0.25; color: var(--brand-gold);" aria-hidden="true"></i>
                            <p style="font-family: 'Playfair Display', serif; font-size: 1.05rem; font-style: italic; color: var(--brand-dark); line-height: 1.6; margin-top: 0.5rem;">{{ $testi->quote }}</p>
                        @endif
                    </div>
                </div>
            </div>
