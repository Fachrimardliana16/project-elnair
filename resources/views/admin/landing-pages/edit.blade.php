...
@section('content')
    <form action="{{ route('admin.landing-pages.update', $landingPage->id) }}" method="POST" enctype="multipart/form-data" id="landingPageForm">
        @csrf
        @method('PUT')
        <div style="display: flex; gap: 0; align-items: stretch; height: calc(100vh - 120px); border: 1px solid #ddd; border-radius: 8px; overflow: hidden; background: #fff;" id="main-workspace">
            ...
            <div id="left-form-panel" style="width: 300px; flex-shrink: 0; height: 100%; display: flex; flex-direction: column; border-right: 1px solid #ddd; transition: all 0.3s; overflow: hidden;">
                ...
                <div style="padding: 15px; overflow-y: auto; flex-grow: 1;">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="title" class="form-control form-control-sm @error('title') is-invalid @enderror" required value="{{ old('title', $landingPage->title) }}">
                        @error('title') <div class="invalid-feedback d-block" style="font-size:0.8rem;">{{ $message }}</div> @enderror
                    </div>
                    
                    <div class="form-group mb-3">
                        <label style="font-size: 0.9rem;">URL Slug</label>
                        <input type="text" name="slug" class="form-control form-control-sm @error('slug') is-invalid @enderror" value="{{ old('slug', $landingPage->slug) }}" placeholder="promo-haji">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="custom_domain" class="form-control form-control-sm" value="{{ old('custom_domain', $landingPage->custom_domain) }}" placeholder="cth: promoelnair.info">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div style="margin-bottom: 10px;">
                            <img src="{{ asset($landingPage->hero_image) }}" alt="Hero" style="height: 60px; border-radius: 4px;">
                        </div>
                        @endif
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="custom_wa_number" class="form-control form-control-sm" value="{{ old('custom_wa_number', $landingPage->custom_wa_number) }}" placeholder="628123456789, 628987654321">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="custom_wa_message" class="form-control form-control-sm" rows="2" placeholder="Halo Elnair...">{{ old('custom_wa_message', $landingPage->custom_wa_message) }}</textarea>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="meta_title" class="form-control form-control-sm" value="{{ old('meta_title', $landingPage->meta_title) }}" placeholder="Meta title">
                    </div>

                    <div class="form-group mb-3">
                        <label style="font-size: 0.9rem;">Meta Description</label>
                        <textarea name="meta_description" class="form-control form-control-sm" rows="3">{{ old('meta_description', $landingPage->meta_description) }}</textarea>
                    </div>

                    <div class="form-group mb-3">
                        <label style="font-size: 0.9rem;">Custom HTML/Header Script (Global)</label>
                        <textarea name="pixel_script" class="form-control form-control-sm" rows="2" placeholder="<!-- Tambahan script HTML kustom mentah apa saja -->">{{ old('pixel_script', $landingPage->pixel_script) }}</textarea>
                    </div>
                        ...
                        <details style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 6px; margin-bottom: 8px; overflow: hidden;">
                            ...
                            <div style="padding: 10px;">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="fb_pixel_id" class="form-control form-control-sm" value="{{ old('fb_pixel_id', $landingPage->fb_pixel_id) }}" placeholder="ID Pixel">
                                </div>
                                <div class="form-group">
                                    <label style="font-size: 0.75rem; font-weight: bold; margin-bottom: 3px; display: block;">Meta CAPI Access Token</label>
                                    <textarea name="fb_capi_token" class="form-control form-control-sm" rows="2" placeholder="EAABw...">{{ old('fb_capi_token', $landingPage->fb_capi_token) }}</textarea>
                                </div>
                            </div>
                        </details>
                        ...
                        <details style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 6px; margin-bottom: 8px; overflow: hidden;">
                            ...
                            <div style="padding: 10px;">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="tiktok_pixel_id" class="form-control form-control-sm" value="{{ old('tiktok_pixel_id', $landingPage->tiktok_pixel_id) }}" placeholder="ID Pixel TikTok">
                                </div>
                                <div class="form-group">
                                    <label style="font-size: 0.75rem; font-weight: bold; margin-bottom: 3px; display: block;">TikTok CAPI Access Token</label>
                                    <textarea name="tiktok_capi_token" class="form-control form-control-sm" rows="2" placeholder="Token CAPI TikTok">{{ old('tiktok_capi_token', $landingPage->tiktok_capi_token) }}</textarea>
                                </div>
                            </div>
                        </details>
                        ...
                        <details style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 6px; margin-bottom: 8px; overflow: hidden;">
                            ...
                            <div style="padding: 10px;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="snack_pixel_id" class="form-control form-control-sm" value="{{ old('snack_pixel_id', $landingPage->snack_pixel_id) }}" placeholder="ID Pixel Snack Video">
                                </div>
                            </div>
                        </details>
                        ...
                        <details style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 6px; overflow: hidden;">
                            ...
                            <div style="padding: 10px;">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="google_pixel_id" class="form-control form-control-sm" value="{{ old('google_pixel_id', $landingPage->google_pixel_id) }}" placeholder="AW-XXXXXXXXX">
                                </div>
                                <div class="form-group">
                                    <label style="font-size: 0.75rem; font-weight: bold; margin-bottom: 3px; display: block;">Google Conversion Label</label>
                                    <input type="text" name="google_conversion_label" class="form-control form-control-sm" value="{{ old('google_conversion_label', $landingPage->google_conversion_label) }}" placeholder="Contoh: abcdEFGH1234">
                                </div>
                            </div>
                        </details>
                    </div>
                    ...
                    <button type="submit" class="btn-admin w-100" style="margin-bottom: 10px;">Update Landing Page</button>
            ...
            <div id="right-builder-panel" style="flex-grow: 1; height: 100%; display: flex; flex-direction: column; min-width: 0; transition: all 0.3s;">
                ...
                <div style="flex-grow: 1; overflow: hidden; position: relative;">
                    ...
                    <textarea name="content" id="content-textarea" style="display: none;">{!! old('content', $landingPage->content) !!}</textarea>
                </div>
            </div>
        </div>
    </form>
...
<script>
    ...
    // Load existing content into canvas
    const existingContent = document.getElementById('content-textarea').value;
    if(existingContent) {
    ...
    // Data dari database
    const existingPixelEvents = {!! json_encode(old('fb_pixel_events', $landingPage->fb_pixel_events ?? [])) !!};
    ...
    // Auto-populate on load for Edit page
    document.addEventListener('DOMContentLoaded', function() {
        if (existingPixelEvents && typeof existingPixelEvents === 'object') {
            // Karena ini adalah object / array dari PHP, kita loop valuenya
            Object.values(existingPixelEvents).forEach(evt => addPixelEvent(evt));
        }
    });
    // ------------------------------------------
</script>
